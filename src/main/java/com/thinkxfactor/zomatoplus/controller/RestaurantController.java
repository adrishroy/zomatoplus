...
import com.thinkxfactor.zomatoplus.repository.AddItemRepository;
...
public class RestaurantController {
	...
	@GetMapping("/allitems")
	public List<AddItem> getAl(){
		List<AddItem> listofitem=additemRepository.findAll();
	...
	public AddItem additem(@RequestBody AddItem item) {
		AddItem persisteditems=additemRepository.save(item); 
